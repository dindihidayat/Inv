<div class="container-fluid">
	<div class="col-md-12">
		...
		<div class="card">
			<div class="card-body">
				<div class="col-md-12">
					<form action="<?php echo base_url('index.php/distribusi/tambah') ?>" method="get" accept-charset="utf-8">
					<div class="form-group">
                      ...
                      <div class="input-group">
                    	...
                    	<a href="<?php echo base_url('index.php/distribusi/tambah') ?>" class="btn btn-default"><i class="fa fa-refresh"></i></a>
                        </div>
                      </div>
                    </div>
					</form>
				...
				<div class="row">
					<div class="col-md-3">
						<div class="form-group">
							...
							<input type="text" class="form-control datetime dontempty_tgl" name="tgl_bast_u" placeholder="Tanggal BAST-U">
						</div>
					</div>
					<div class="col-md-3">
						<div class="form-group">
							<label class="form-label">Nomor BAST-U</label>
							<input type="text" class="form-control dontempty_no" name="no_bast_u" placeholder="Nomor BAST-U">
						</div>
					</div>
					<div class="col-md-6">
						<div class="form-group">
							<label class="form-label">Penerima Barang</label>
							<input type="text" class="form-control dontempty_pic" name="pic" placeholder="Penerima Barang">
						</div>
					</div>
					<div class="col-md-12">
						<hr>
