                ...
                <div class="card">
                  ...
                  <div class="card-body">
	                   <ul class="nav nav-tabs" role="tablist">
						  <li class="nav-item">
						    <a class="nav-link active" href="#profile<?php echo $key->id_barang ?>" role="tab" data-toggle="tab">Detail Barang</a>
						  </li>
						  <li class="nav-item">
                  ...
                  <div class="card-footer">
                    Penanggung Jawab Barang : <span class="text-info"><strong><?php echo $key->pic ?></strong></span>
                  </div>
                </div>
              </div>
			<?php endforeach ?>
